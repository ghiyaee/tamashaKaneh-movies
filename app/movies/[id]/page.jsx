      ...
      <section className="text-[2rem] ">
        ...
        {movie.id === 2 ? (
          <video className="w-[50%]" controls>
            <source src="https://aspb14.asset.aparat.com/aparat-video/137842034f6b486673d83c8520bd620118070579-360p.mp4?wmsAuthSign=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbiI6IjhiY2UzMjMxMjFkMGEzYWRhMjM5MjE0OTRjZWMwMGUyIiwiZXhwIjoxNjc2OTE0MjEzLCJpc3MiOiJTYWJhIElkZWEgR1NJRyJ9.xZOpDY_c9oJBncMOQ1jHe-2mNCCF_0NzXdYcw6rWuvQ" />
